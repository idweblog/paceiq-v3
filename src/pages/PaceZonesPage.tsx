...
const PACE_ZONES: PaceZone[] = [
  ...
  { key: 'aerob',          name: 'Aerobic Power (Supra-Threshold)', pctVcrLo: 1.00, pctVcrHi: 1.02, pctLthrLo: 95,  pctLthrHi: 99,  color: '#8b5cf6', bgColor: '#f5f3ff', rpe: '8–9',  desc: 'Anchor VCR 100% — pace TT 30 menit',                usage: '5K pace reps, supra-threshold interval',            ref: '100–102% VCR — ANCHOR' },
  { key: 'interval',       name: 'Interval (VO₂Max)',               pctVcrLo: 1.03, pctVcrHi: 1.05, pctLthrLo: 100, pctLthrHi: 106, color: '#6366f1', bgColor: '#eef2ff', rpe: '9',         desc: 'VO₂max improvement, cardiac output maksimal',       usage: 'Track interval 3–5 mnt, 1200m/1600m reps',         ref: '103–105% VCR' },
