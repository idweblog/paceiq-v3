  ...
  return (
    <div className="p-6 w-full max-w-[1400px] space-y-6">
      ...
      <section className="bg-white rounded-xl shadow-sm p-5">
        <div className="font-gsans text-xl text-indigo-700 uppercase mb-4 pb-2 border-b border-indigo-100">Identitas Atlet</div>
      ...
      {/* ── DATA PERFORMA ── */}
      <section className="bg-white rounded-xl shadow-sm p-5">
        <div className="font-gsans text-xl text-indigo-700 uppercase mb-4 pb-2 border-b border-indigo-100">Data Performa</div>
      ...
      <section className="bg-white rounded-xl shadow-sm p-5">
        <div className="flex items-center justify-between mb-4">
          <div className="font-gsans text-xl text-indigo-700 uppercase">TIME TRIAL HISTORY</div>
      ...
      <section className="bg-white rounded-xl shadow-sm p-5">
        <div className="flex items-center justify-between mb-4 pb-2 border-b border-indigo-100">
          <div className="font-gsans text-xl text-indigo-700 uppercase">🌤️ CUACA LATIHAN & RACE</div>
