  ...
  return (
    <div className="p-6 w-full max-w-[1400px] space-y-6">
      ...
      <section className="bg-white rounded-xl shadow-sm p-5">
        <div className="font-gsans text-base text-indigo-700 mb-4 pb-2 border-b border-indigo-100">Identitas Atlet</div>
      ...
      {/* ── DATA PERFORMA ── */}
      <section className="bg-white rounded-xl shadow-sm p-5">
        <div className="font-gsans text-base text-indigo-700 mb-4 pb-2 border-b border-indigo-100">Data Performa</div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-gray-50 rounded-xl p-4 col-span-2">
            ...
            {/* ── RACE PREDICTION ── */}
      <section className="bg-white rounded-xl shadow-sm p-5">
        <div className="font-gsans text-base text-indigo-700 mb-4 pb-2 border-b border-indigo-100">Race Prediction</div>
        ...
        {races.length > 0 && latestTt && latestTt.distance_km && (
          <div>
            ...
            {/* ── FITNESS DASHBOARD ── */}
      <section className="bg-white rounded-xl shadow-sm p-5">
        <div className="font-gsans text-base text-indigo-700 mb-4 pb-2 border-b border-indigo-100">Fitness Dashboard</div>
        {!fitness ? (
      ...
      {/* ── EFFICIENCY & ECONOMY ── */}
      <section className="bg-white rounded-xl shadow-sm p-5">
        <div className="font-gsans text-base text-indigo-700 mb-4 pb-2 border-b border-indigo-100">Efficiency &amp; Economy</div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
      ...
      <section className="bg-white rounded-xl shadow-sm p-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div>
            ...
            {/* ── HEAT STRESS INDEX ── */}
      <section className="bg-white rounded-xl shadow-sm p-5">
        <div className="font-gsans text-base text-indigo-700 mb-4 pb-2 border-b border-indigo-100">🌡️ Heat Stress Index</div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <div>
